    ...
    >
          ...
          <div className="d-flex justify-content-between align-items-center flex-grow-1 gap-12 flex-wrap">
            <div className="tf-product-bundle-infos">
              ...
              <div className="tf-product-info-price type-small">
                <h5 className="price-on-sale"><CurrencyFormatter price={product.price} /></h5>
                {product.oldPrice && (
                  <div className="compare-at-price"><CurrencyFormatter price={product.oldPrice} /></div>
                )}
                {product.discount && (
      ...
      <div className="tf-bundle-product-total-submit">
        ...
        <div className="tf-product-info-price type-1">
          <h4 className="price-on-sale"><CurrencyFormatter price={totalPrice} /></h4>
          <div className="compare-at-price"><CurrencyFormatter price={totalPriceOld} /></div>
